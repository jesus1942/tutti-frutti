...
const translations = {
    ...
    es: {
        ...
        "live": "En vivo",
        "scores-subtitle": "Resumen final de la partida con podio y detalle por ronda.",
        "scores-leader": "Liderando la partida",
        "points-distributed": "puntos distribuidos",
        "position": "Posición",
        "ranking-final": "Ranking final",
        "total-accumulated": "Total acumulado",
        "no-round": "Sin ronda cerrada",
        "no-scores-yet": "Todavía no hay puntajes cargados.",
        "medal-gold": "Oro",
        "medal-silver": "Plata",
        "medal-bronze": "Bronce",
        "conn-connecting": "Conectando a la sala {room}...",
        "conn-established": "¡Conexión establecida! Bienvenido a la sala {room}",
        "conn-waking": "Despertando el servidor (la primera vez puede tardar hasta 1 minuto)...",
        "conn-closed": "La conexión con el servidor se ha cerrado.",
        "conn-failed": "No se pudo conectar al servidor. Esperá unos segundos y volvé a intentar.",
        "conn-missing-backend": "Falta configurar el backend del juego. Agrega ?backend=https://tu-backend o define window.TUTTI_CONFIG.backendUrl.",
    ...
    en: {
        ...
        "live": "Live",
        "scores-subtitle": "Final game summary with podium and per-round detail.",
        "scores-leader": "Leading the game",
        "points-distributed": "points awarded",
        "position": "Position",
        "ranking-final": "Final ranking",
        "total-accumulated": "Accumulated total",
        "no-round": "No round closed",
        "no-scores-yet": "No scores loaded yet.",
        "medal-gold": "Gold",
        "medal-silver": "Silver",
        "medal-bronze": "Bronze",
        "conn-connecting": "Connecting to room {room}...",
        "conn-established": "Connected! Welcome to room {room}",
        "conn-waking": "Waking up the server (the first time it can take up to a minute)...",
        "conn-closed": "The connection to the server was closed.",
        "conn-failed": "Couldn't connect to the server. Wait a few seconds and try again.",
        "conn-missing-backend": "The game backend is not configured. Add ?backend=https://your-backend or set window.TUTTI_CONFIG.backendUrl.",
    ...
    it: {
        ...
        "live": "In diretta",
        "scores-subtitle": "Riepilogo finale della partita con podio e dettaglio per round.",
        "scores-leader": "In testa alla partita",
        "points-distributed": "punti distribuiti",
        "position": "Posizione",
        "ranking-final": "Classifica finale",
        "total-accumulated": "Totale accumulato",
        "no-round": "Nessun round chiuso",
        "no-scores-yet": "Ancora nessun punteggio caricato.",
        "medal-gold": "Oro",
        "medal-silver": "Argento",
        "medal-bronze": "Bronzo",
        "conn-connecting": "Connessione alla stanza {room}...",
        "conn-established": "Connessione stabilita! Benvenuto nella stanza {room}",
        "conn-waking": "Risveglio del server (la prima volta può richiedere fino a un minuto)...",
        "conn-closed": "La connessione con il server è stata chiusa.",
        "conn-failed": "Impossibile connettersi al server. Aspetta qualche secondo e riprova.",
        "conn-missing-backend": "Il backend del gioco non è configurato. Aggiungi ?backend=https://tuo-backend o imposta window.TUTTI_CONFIG.backendUrl.",
    ...
    pt: {
        ...
        "live": "Ao vivo",
        "scores-subtitle": "Resumo final da partida com pódio e detalhe por rodada.",
        "scores-leader": "Liderando a partida",
        "points-distributed": "pontos distribuídos",
        "position": "Posição",
        "ranking-final": "Ranking final",
        "total-accumulated": "Total acumulado",
        "no-round": "Nenhuma rodada fechada",
        "no-scores-yet": "Ainda não há pontuações carregadas.",
        "medal-gold": "Ouro",
        "medal-silver": "Prata",
        "medal-bronze": "Bronze",
        "conn-connecting": "Conectando à sala {room}...",
        "conn-established": "Conexão estabelecida! Bem-vindo à sala {room}",
        "conn-waking": "Acordando o servidor (na primeira vez pode levar até um minuto)...",
        "conn-closed": "A conexão com o servidor foi encerrada.",
        "conn-failed": "Não foi possível conectar ao servidor. Espere alguns segundos e tente de novo.",
        "conn-missing-backend": "O backend do jogo não está configurado. Adicione ?backend=https://seu-backend ou defina window.TUTTI_CONFIG.backendUrl.",
